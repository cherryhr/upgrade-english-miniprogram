...
function getAudioContext() {
  if (!audioContext) {
    ...
    // 设置0.8x语速，适合儿童
    audioContext.playbackRate = PLAYBACK_RATE;
...
function cleanText(text) {
  ...
  let clean = text
    ...
    .replace(/[，。]/g, ',')
    .replace(/,/g, ' ')
    .replace(/[.。]+/g, ' ')    // 移除句号（替换为空格，避免影响前后单词合并）
...
function getCosFilename(text) {
  ...
  const fullMap = [
    // U1 问候与告别
    { text: "hi my name is amy", file: "hi_my_name_is_amy_nice_to_meet_you.mp3" },
    ...
    { text: "im five years old", file: "im_five_years_old.mp3" },
    { text: "im five years old.", file: "im_five_years_old.mp3" },
    { text: "i m five years old", file: "im_five_years_old.mp3" },
    { text: "i m five years old.", file: "im_five_years_old.mp3" },
    { text: "i am five years old", file: "im_five_years_old.mp3" },
    { text: "i am five years old.", file: "im_five_years_old.mp3" },
    ...
    { text: "this is my family mum dad and me", file: "this_is_my_family_mum_dad_and_me.mp3" },
    ...
    { text: "yes nice to meet you", file: "yes_let_us_be_friends.mp3" },
    { text: "yes nice to meet you nice to meet you", file: "yes_let_us_be_friends.mp3" },
    ...
    { text: "its my birthday today", file: "its_my_birthday_today.mp3" },
    { text: "my sister took my pencil im angry", file: "my_sister_took_my_pencil_im_angry.mp3" },
    { text: "my sister took my pen so i am angry", file: "my_sister_took_my_pen_so_i_am_angry.mp3" },
    { text: "its red red like a fire engine", file: "its_red_red_like_a_fire_engine.mp3" },
    { text: "im four years old four candles on my cake", file: "i_am_four_years_old_four_candles_on_my_cake.mp3" },
    { text: "im four years old four candles are on my cake", file: "i_am_four_years_old_four_candles_on_my_cake.mp3" },
    ...
    { text: "the elephant is very big", file: "the_elephant_is_very_big.mp3" },
    { text: "no i dont like carrots but i like pizza", file: "no_i_dont_like_carrots_but_i_like_pizza.mp3" },
    ...
    { text: "where are your from?", file: "where_are_you_from.mp3" },
    { text: "i'm from beijing. where are you from?", file: "im_from_beijing.mp3" },
    { text: "i am from beijing. where are you from?", file: "i_am_from_beijing_where_are_you_from.mp3" },
    { text: "i am from beijing where are you from", file: "i_am_from_beijing_where_are_you_from.mp3" },
    ...
    { text: "yes nice to meet you let s be friends", file: "yes_let_us_be_friends.mp3" },
    { text: "yes nice to meet you nice to meet you", file: "yes_let_us_be_friends.mp3" },
    { text: "nice to meet you nice to meet you", file: "nice_to_meet_you.mp3" },
    { text: "nice to meet you!", file: "nice_to_meet_you.mp3" },
    { text: "nice to meet you", file: "nice_to_meet_you.mp3" },
    { text: "lets be friends", file: "yes_let_us_be_friends.mp3" },

    // U4 情绪
    { text: "how are you feeling today", file: "how_are_you_feeling_today.mp3" },
    { text: "i am feeling happy today and i love school", file: "im_feeling_happy_today_i_love_school.mp3" },
    ...
    { text: "its my birthday today i am so excited", file: "its_my_birthday_today.mp3" },
    { text: "its my birthday today and i am so excited", file: "its_my_birthday_today.mp3" },
    { text: "its my birthday today and i m so excited", file: "its_my_birthday_today.mp3" },
    { text: "i am so excited", file: "its_my_birthday_today.mp3" },
    { text: "i m so excited", file: "its_my_birthday_today.mp3" },
    { text: "why are you angry", file: "why_are_you_angry.mp3" },
    { text: "so i am angry", file: "so_i_am_angry.mp3" },
    { text: "so i m angry", file: "so_i_am_angry.mp3" },
    ...
    { text: "yellow like the sun", file: "my_favourite_colour_is_yellow.mp3" },
    { text: "yellow yellow like the sun", file: "my_favourite_colour_is_yellow.mp3" },
    { text: "favourite colour is yellow yellow like the sun", file: "my_favourite_colour_is_yellow.mp3" },
    { text: "can you see a rainbow? how many colours?", file: "can_you_see_a_rainbow_how_many_colours.mp3" },
    { text: "can you see a rainbow how many colours", file: "can_you_see_a_rainbow_how_many_colours.mp3" },
    { text: "yes! a rainbow has seven beautiful colours!", file: "yes_a_rainbow_has_seven_beautiful_colours.mp3" },
    ...
    { text: "i am four years old four candles on my cake", file: "i_am_four_years_old_four_candles_on_my_cake.mp3" },
    { text: "i am four years old. four candles on my cake", file: "i_am_four_years_old_four_candles_on_my_cake.mp3" },
    { text: "i'm four years old! four candles on my cake!", file: "i_am_four_years_old_four_candles_on_my_cake.mp3" },
    { text: "i am four years old", file: "i_am_four_years_old_four_candles_on_my_cake.mp3" },
    { text: "i am four years old four candles on my cake", file: "i_am_four_years_old_four_candles_on_my_cake.mp3" },
    { text: "four candles on my cake", file: "i_am_four_years_old_four_candles_on_my_cake.mp3" },
    { text: "four candles are on my cake", file: "i_am_four_years_old_four_candles_on_my_cake.mp3" },
    ...
    { text: "the elephant is very big its the biggest land animal", file: "the_elephant_is_very_big.mp3" },
    { text: "the elephant is very big its the biggest land animal", file: "the_elephant_is_very_big.mp3" },
    { text: "its the biggest land animal", file: "the_elephant_is_very_big.mp3" },
    { text: "the biggest land animal", file: "the_elephant_is_very_big.mp3" },
    { text: "biggest land animal", file: "the_elephant_is_very_big.mp3" },
    { text: "what does a lion do", file: "what_does_a_lion_do.mp3" },
    { text: "a lion roars! roar! lions are very brave!", file: "a_lion_roars.mp3" },
    { text: "a lion roars roar lions are very brave", file: "a_lion_roars.mp3" },
    { text: "lions are very brave", file: "a_lion_roars.mp3" },
    { text: "lion roars roar lions are very brave", file: "a_lion_roars.mp3" },
    { text: "roar lions are very brave", file: "a_lion_roars.mp3" },
    { text: "roar lions are very brave", file: "a_lion_roars.mp3" },

    // U8 家庭
    { text: "who is this in the photo?", file: "who_is_this_in_the_photo.mp3" },
    { text: "this is my family! mum, dad, and me!", file: "this_is_my_family_mum_dad_and_me.mp3" },
    { text: "mum dad and me", file: "mum_and_dad_and_me.mp3" },
    { text: "mum dad and me!", file: "mum_and_dad_and_me.mp3" },
    { text: "this is my family mum dad and me", file: "this_is_my_family_mum_dad_and_me.mp3" },
    { text: "dad and me", file: "mum_and_dad_and_me.mp3" },
    { text: "is your dad tall?", file: "is_your_dad_tall.mp3" },
    { text: "yes! my dad is very tall and strong!", file: "yes_my_dad_is_very_tall_and_strong.mp3" },
    { text: "do you love your grandma?", file: "do_you_love_your_grandma.mp3" },
    { text: "yes! i love my grandma very much! she makes yummy food!", file: "yes_i_love_my_grandma.mp3" },
    { text: "yes i love my grandma very much she makes yummy food", file: "yes_i_love_my_grandma.mp3" },
    { text: "she makes yummy food", file: "yes_i_love_my_grandma.mp3" },
    { text: "makes yummy food", file: "yes_i_love_my_grandma.mp3" },
    { text: "yummy food", file: "yes_i_love_my_grandma.mp3" },
    { text: "very much she makes yummy food", file: "yes_i_love_my_grandma.mp3" },
    ...
    { text: "here is my nose! right here in the middle of my face!", file: "here_is_my_nose.mp3" },
    { text: "here is my nose right here in the middle of my face", file: "here_is_my_nose.mp3" },
    { text: "right here in the middle of my face", file: "here_is_my_nose.mp3" },
    { text: "here is my nose right here in the middle of my face", file: "here_is_my_nose.mp3" },
    { text: "in the middle of my face", file: "here_is_my_nose.mp3" },
    { text: "middle of my face", file: "here_is_my_nose.mp3" },
    { text: "how many eyes do you have", file: "how_many_eyes_do_you_have.mp3" },
    { text: "i have two eyes! two big beautiful eyes!", file: "i_have_two_eyes.mp3" },
    { text: "i have two eyes two big beautiful eyes", file: "i_have_two_eyes.mp3" },
    { text: "two big beautiful eyes", file: "i_have_two_eyes.mp3" },
    { text: "what can you do with your hands", file: "what_can_you_do_with_your_hands.mp3" },
    { text: "here is my nose", file: "here_is_my_nose.mp3" },
    { text: "i can clap wave draw", file: "i_can_clap_wave_draw.mp3" },
    { text: "i can clap wave draw and play with my hands", file: "i_can_clap_wave_draw.mp3" },
    { text: "i can clap, wave, draw and play with my hands!", file: "i_can_clap_wave_draw.mp3" },
    { text: "and play with my hands", file: "i_can_clap_wave_draw.mp3" },

    // U10 食物
    { text: "what do you like to eat", file: "what_do_you_like_to_eat.mp3" },
    { text: "i like apples and bananas! they are sweet and yummy!", file: "i_like_apples_and_bananas.mp3" },
    { text: "i like apples and bananas they are sweet and yummy", file: "i_like_apples_and_bananas.mp3" },
    { text: "they are sweet and yummy", file: "i_like_apples_and_bananas.mp3" },
    ...
    { text: "yes! yummy! it is so delicious! can i have more?", file: "yes_yummy_it_is_so_delicious.mp3" },
    { text: "yes yummy it is so delicious can i have more", file: "yes_yummy_it_is_so_delicious.mp3" },
    { text: "can i have more", file: "yes_yummy_it_is_so_delicious.mp3" },
    { text: "can i have more?", file: "yes_yummy_it_is_so_delicious.mp3" },

    // U11 玩具
    { text: "what is your favourite toy", file: "what_is_your_favourite_toy.mp3" },
    { text: "my favourite toy is my teddy bear", file: "my_favourite_toy_is_my_teddy_bear.mp3" },
    { text: "my favourite toy is my teddy bear! his name is brown!", file: "my_favourite_toy_is_my_teddy_bear.mp3" },
    { text: "my favourite toy is my teddy bear his name is brown", file: "my_favourite_toy_is_my_teddy_bear.mp3" },
    { text: "his name is brown", file: "his_name_is_brown.mp3" },
    { text: "teddy bear his name is brown", file: "my_favourite_toy_is_my_teddy_bear.mp3" },
    ...
    { text: "listen to me hello hello hello", file: "yes_i_can_sing.mp3" },
    { text: "yes! i can sing! listen to me: hello hello hello!", file: "yes_i_can_sing.mp3" },
    { text: "yes i can sing listen to me hello hello hello", file: "yes_i_can_sing.mp3" },
    { text: "hello hello hello", file: "hello_hello_hello.mp3" },
    { text: "what have you learned in upgrade english", file: "what_have_you_learned.mp3" },
    { text: "what have you learned in upgrade english review and show", file: "what_have_you_learned.mp3" },
    { text: "in upgrade english", file: "what_have_you_learned.mp3" },
    { text: "you learned in upgrade english", file: "what_have_you_learned.mp3" },
    { text: "i learned greetings, colours, numbers, animals and more!", file: "i_learned_greetings_colours_numbers_and_more.mp3" },
    ...
    // ========== 补全映射（防止前缀截断）==========
    // U3 Where are you from（Q 和 A）
    { text: "where are you from", file: "where_are_you_from.mp3" },
    // U3 My name is Lily
    { text: "my name is lily what about you", file: "my_name_is_lily_what_about_you.mp3" },
    // U4 My sister took my pen
    { text: "my sister took my pen so i am angry", file: "my_sister_took_my_pen_so_i_am_angry.mp3" },
    // U6 How old / candles
    { text: "how old are you how many candles", file: "how_old_are_you_how_many_candles.mp3" },
    { text: "i am four years old four candles are on my cake", file: "i_am_four_years_old_four_candles_on_my_cake.mp3" },
    // U11 play ball with me
    { text: "do you want to play ball with me", file: "do_you_want_to_play_ball_with_me.mp3" },
    { text: "yes miss i am sitting down now", file: "yes_miss_i_am_sitting_down_now.mp3" },
    ...
    { text: "is your dad tall", file: "is_your_dad_tall.mp3" },
    { text: "yes my dad is very tall and strong", file: "yes_my_dad_is_very_tall_and_strong.mp3" },
    { text: "my dad is very tall and strong", file: "yes_my_dad_is_very_tall_and_strong.mp3" },
    { text: "do you love your grandma", file: "do_you_love_your_grandma.mp3" },
    { text: "yes i love my grandma very much", file: "yes_i_love_my_grandma_very_much.mp3" },
    { text: "i love my grandma very much she makes yummy food", file: "yes_i_love_my_grandma_very_much.mp3" },
    { text: "i love my family", file: "i_love_my_family.mp3" },
    { text: "happy happy family", file: "happy_happy_family.mp3" },
  ...
  // ===== 新增童声英式发音映射 (VoiceType=101004) =====
  const kidsEnglishMap = [
    { text: "a - apple", file: "a_apple.mp3" },
    { text: "a lion roars roar lions are very brave", file: "a_lion_roars_roar_lions_are_very_brave.mp3" },
    { text: "angry", file: "angry.mp3" },
    { text: "apple", file: "apple.mp3" },
    { text: "arm", file: "arm.mp3" },
    { text: "b - ball", file: "b_ball.mp3" },
    ...
    { text: "friend", file: "friend.mp3" },
    { text: "fun", file: "fun.mp3" },
    { text: "g - gorilla", file: "g_gorilla.mp3" },
    { text: "giraffe", file: "giraffe.mp3" },
    { text: "girl", file: "girl.mp3" },
    { text: "go", file: "go.mp3" },
    { text: "good afternoon", file: "good_afternoon.mp3" },
    ...
    { text: "good night", file: "good_night.mp3" },
    { text: "goodbye", file: "goodbye.mp3" },
    { text: "gorilla", file: "gorilla.mp3" },
    { text: "grandma", file: "grandma.mp3" },
    { text: "grandpa", file: "grandpa.mp3" },
    { text: "green", file: "green.mp3" },
    { text: "h - horse", file: "h_horse.mp3" },
    { text: "hair", file: "hair.mp3" },
    { text: "hand", file: "hand.mp3" },
    { text: "hands up hands up", file: "hands_up_hands_up.mp3" },
    { text: "happy", file: "happy.mp3" },
    { text: "has it", file: "has_it.mp3" },
    { text: "have a good day", file: "have_a_good_day.mp3" },
    { text: "hello", file: "hello.mp3" },
    { text: "hello hello hello", file: "hello_hello_hello.mp3" },
    { text: "hello what is your name?", file: "hello_what_is_your_name.mp3" },
    { text: "help", file: "help.mp3" },
    { text: "here you are", file: "here_you_are.mp3" },
    { text: "here is my nose", file: "here_is_my_nose.mp3" },
    { text: "hi", file: "hi.mp3" },
    { text: "hi my name is amy nice to meet you", file: "hi_my_name_is_amy_nice_to_meet_you.mp3" },
    { text: "hippopotamus", file: "hippopotamus.mp3" },
    { text: "home", file: "home.mp3" },
    { text: "hope", file: "hope.mp3" },
    { text: "horse", file: "horse.mp3" },
    { text: "hot", file: "hot.mp3" },
    { text: "how are you?", file: "how_are_you.mp3" },
    { text: "how many colours?", file: "how_many_colours.mp3" },
    { text: "how old are you?", file: "how_old_are_you.mp3" },
    { text: "hundred", file: "hundred.mp3" },
    { text: "i am", file: "i_am.mp3" },
    { text: "i am a champion", file: "i_am_a_champion.mp3" },
    { text: "i am happy today", file: "i_am_happy_today.mp3" },
    { text: "i am sad", file: "i_am_sad.mp3" },
    { text: "i can", file: "i_can.mp3" },
    { text: "i dont like", file: "i_dont_like.mp3" },
    { text: "i have two eyes", file: "i_have_two_eyes.mp3" },
    { text: "i like", file: "i_like.mp3" },
    { text: "i like apples and bananas", file: "i_like_apples_and_bananas.mp3" },
    { text: "i like you", file: "i_like_you.mp3" },
    { text: "i love you", file: "i_love_you.mp3" },
    { text: "i see a rainbow", file: "i_see_a_rainbow.mp3" },
    { text: "i see seven beautiful colours", file: "i_see_seven_beautiful_colours.mp3" },
    { text: "i see seven colours", file: "i_see_seven_colours.mp3" },
    { text: "i see", file: "i_see.mp3" },
    { text: "i see you", file: "i_see_you.mp3" },
    { text: "i want to be your friend", file: "i_want_to_be_your_friend.mp3" },
    { text: "i want", file: "i_want.mp3" },
    { text: "in", file: "in.mp3" },
    { text: "is it", file: "is_it.mp3" },
    { text: "it is", file: "it_is.mp3" },
    { text: "it says", file: "it_says.mp3" },
    { text: "j - jacket", file: "j_jacket.mp3" },
    { text: "jacket", file: "jacket.mp3" },
    { text: "jump", file: "jump.mp3" },
    { text: "k - kite", file: "k_kite.mp3" },
    { text: "kangaroo", file: "kangaroo.mp3" },
    { text: "kite", file: "kite.mp3" },
    { text: "l - lion", file: "l_lion.mp3" },
    { text: "laugh", file: "laugh.mp3" },
    { text: "left", file: "left.mp3" },
    { text: "leg", file: "leg.mp3" },
    { text: "let us be friends", file: "let_us_be_friends.mp3" },
    { text: "lion", file: "lion.mp3" },
    { text: "listen", file: "listen.mp3" },
    { text: "listen to me", file: "listen_to_me.mp3" },
    { text: "look at me", file: "look_at_me.mp3" },
    { text: "look", file: "look.mp3" },
    { text: "look at this", file: "look_at_this.mp3" },
    { text: "m - monkey", file: "m_monkey.mp3" },
    { text: "meow", file: "meow.mp3" },
    { text: "milk", file: "milk.mp3" },
    { text: "monkey", file: "monkey.mp3" },
    { text: "more", file: "more.mp3" },
    { text: "morning", file: "morning.mp3" },
    { text: "mother", file: "mother.mp3" },
    { text: "mouth", file: "mouth.mp3" },
    { text: "mum", file: "mum.mp3" },
    { text: "mummy", file: "mummy.mp3" },
    { text: "my favourite colour is", file: "my_favourite_colour_is.mp3" },
    { text: "my favourite toy is", file: "my_favourite_toy_is.mp3" },
    { text: "my favourite toy is my teddy bear", file: "my_favourite_toy_is_my_teddy_bear.mp3" },
    { text: "my head", file: "my_head.mp3" },
    { text: "my name is", file: "my_name_is.mp3" },
    { text: "n - nest", file: "n_nest.mp3" },
    { text: "name", file: "name.mp3" },
    { text: "nest", file: "nest.mp3" },
    { text: "nice to meet you", file: "nice_to_meet_you.mp3" },
    { text: "nine", file: "nine.mp3" },
    { text: "no i dont like", file: "no_i_dont_like.mp3" },
    { text: "no", file: "no.mp3" },
    { text: "nose", file: "nose.mp3" },
    { text: "not", file: "not.mp3" },
    { text: "o - orange", file: "o_orange.mp3" },
    { text: "oh", file: "oh.mp3" },
    { text: "oh no", file: "oh_no.mp3" },
    { text: "one", file: "one.mp3" },
    { text: "open your book", file: "open_your_book.mp3" },
    { text: "orange", file: "orange.mp3" },
    { text: "p - pig", file: "p_pig.mp3" },
    { text: "panda", file: "panda.mp3" },
    { text: "parent", file: "parent.mp3" },
    { text: "pig", file: "pig.mp3" },
    { text: "please", file: "please.mp3" },
    { text: "point to", file: "point_to.mp3" },
    { text: "purple", file: "purple.mp3" },
    { text: "q - queen", file: "q_queen.mp3" },
    { text: "queen", file: "queen.mp3" },
    { text: "quiet", file: "quiet.mp3" },
    { text: "r - rabbit", file: "r_rabbit.mp3" },
    { text: "rabbit", file: "rabbit.mp3" },
    { text: "rainbow", file: "rainbow.mp3" },
    { text: "rainbow has seven colours", file: "rainbow_has_seven_colours.mp3" },
    { text: "rainbow is beautiful", file: "rainbow_is_beautiful.mp3" },
    { text: "red", file: "red.mp3" },
    { text: "repeat after me", file: "repeat_after_me.mp3" },
    { text: "right", file: "right.mp3" },
    { text: "roar", file: "roar.mp3" },
    { text: "run", file: "run.mp3" },
    { text: "s - sun", file: "s_sun.mp3" },
    { text: "sad", file: "sad.mp3" },
    { text: "say it again please", file: "say_it_again_please.mp3" },
    { text: "say it with me", file: "say_it_with_me.mp3" },
    { text: "see you", file: "see_you.mp3" },
    { text: "seven", file: "seven.mp3" },
    { text: "she is", file: "she_is.mp3" },
    { text: "show me", file: "show_me.mp3" },
    { text: "sing", file: "sing.mp3" },
    { text: "sister", file: "sister.mp3" },
    { text: "sit down", file: "sit_down.mp3" },
    { text: "six", file: "six.mp3" },
    { text: "love", file: "love.mp3" },
    { text: "i love my family", file: "i_love_my_family.mp3" },
    { text: "i love my grandma very much", file: "i_love_my_grandma_very_much.mp3" },
    { text: "sleepy", file: "sleepy.mp3" },
    { text: "song", file: "song.mp3" },
    { text: "stand up stand up", file: "stand_up_stand_up.mp3" },
    { text: "stand up", file: "stand_up.mp3" },
    { text: "stop", file: "stop.mp3" },
    { text: "sun", file: "sun.mp3" },
    { text: "t - tiger", file: "t_tiger.mp3" },
    { text: "ten", file: "ten.mp3" },
    { text: "thank you", file: "thank_you.mp3" },
    { text: "that is", file: "that_is.mp3" },
    { text: "the rainbow has seven beautiful colours", file: "the_rainbow_has_seven_beautiful_colours.mp3" },
    { text: "the rainbow has seven colours", file: "the_rainbow_has_seven_colours.mp3" },
    { text: "there are seven colours in a rainbow", file: "there_are_seven_colours_in_a_rainbow.mp3" },
    { text: "there is", file: "there_is.mp3" },
    { text: "these are my", file: "these_are_my.mp3" },
    { text: "they are", file: "they_are.mp3" },
    { text: "think", file: "think.mp3" },
    { text: "this is", file: "this_is.mp3" },
    { text: "this is my family", file: "this_is_my_family.mp3" },
    { text: "three", file: "three.mp3" },
    { text: "tiger", file: "tiger.mp3" },
    { text: "tired", file: "tired.mp3" },
    { text: "to", file: "to.mp3" },
    { text: "too", file: "too.mp3" },
    { text: "train", file: "train.mp3" },
    { text: "two", file: "two.mp3" },
    { text: "u - umbrella", file: "u_umbrella.mp3" },
    { text: "umbrella", file: "umbrella.mp3" },
    { text: "up", file: "up.mp3" },
    { text: "v - violin", file: "v_violin.mp3" },
    { text: "very much", file: "very_much.mp3" },
    { text: "very well thank you and you?", file: "very_well_thank_you_and_you.mp3" },
    { text: "violin", file: "violin.mp3" },
    { text: "w - whale", file: "w_whale.mp3" },
    { text: "wait", file: "wait.mp3" },
    { text: "wake up", file: "wake_up.mp3" },
    { text: "walk", file: "walk.mp3" },
    { text: "we are friends", file: "we_are_friends.mp3" },
    { text: "we can", file: "we_can.mp3" },
    { text: "we like to", file: "we_like_to.mp3" },
    { text: "well done", file: "well_done.mp3" },
    { text: "well done congratulations you are a champion", file: "well_done_congratulations_you_are_a_champion.mp3" },
    { text: "what", file: "what.mp3" },
    { text: "what animal is this? it says meow", file: "what_animal_is_this_it_says_meow.mp3" },
    { text: "what can you do with your hands?", file: "what_can_you_do_with_your_hands.mp3" },
    { text: "what colour is this apple?", file: "what_colour_is_this_apple.mp3" },
    { text: "what do you like to eat?", file: "what_do_you_like_to_eat.mp3" },
    { text: "what does a lion do?", file: "what_does_a_lion_do.mp3" },
    { text: "what have you learned in upgrade english?", file: "what_have_you_learned_in_upgrade_english.mp3" },
    { text: "what is your favourite colour?", file: "what_is_your_favourite_colour.mp3" },
    { text: "what is your favourite toy?", file: "what_is_your_favourite_toy.mp3" },
    { text: "what shall we do today?", file: "what_shall_we_do_today.mp3" },
    { text: "what shall we do?", file: "what_shall_we_do.mp3" },
    { text: "what would you like?", file: "what_would_you_like.mp3" },
    { text: "where are you from?", file: "where_are_you_from.mp3" },
    { text: "where is your nose? can you point to it?", file: "where_is_your_nose_can_you_point_to_it.mp3" },
    { text: "where is your", file: "where_is_your.mp3" },
    { text: "where is", file: "where_is.mp3" },
    { text: "which colour do you like?", file: "which_colour_do_you_like.mp3" },
    { text: "whale", file: "whale.mp3" },
    { text: "white", file: "white.mp3" },
    { text: "who is this in the photo?", file: "who_is_this_in_the_photo.mp3" },
    { text: "who knows the answer? hands up", file: "who_knows_the_answer_hands_up.mp3" },
    { text: "who is in your family?", file: "who_is_in_your_family.mp3" },
    { text: "why are you angry?", file: "why_are_you_angry.mp3" },
    { text: "why are you so excited?", file: "why_are_you_so_excited.mp3" },
    { text: "x - xylophone", file: "x_xylophone.mp3" },
    { text: "y - yo-yo", file: "y_yoyo.mp3" },
    { text: "yellow", file: "yellow.mp3" },
    { text: "yes a rainbow has seven beautiful colours", file: "yes_a_rainbow_has_seven_beautiful_colours.mp3" },
    { text: "yes i can sing listen to me hello hello hello", file: "yes_i_can_sing_listen_to_me_hello_hello_hello.mp3" },
    { text: "yes i love my grandma very much she makes yummy food", file: "yes_i_love_my_grandma_very_much_she_makes_yummy_fo.mp3" },
    { text: "yes my dad is very tall and strong", file: "yes_my_dad_is_very_tall_and_strong.mp3" },
    { text: "yes one, two, three, four, five, six, seven, eight, nine, ten", file: "yes_one_two_three_four_five_six_seven_eight_nine_t.mp3" },
    { text: "yes yummy it is so delicious can i have more", file: "yes_yummy_it_is_so_delicious_can_i_have_more.mp3" },
    { text: "yes! i", file: "yes_i.mp3" },
    { text: "yes! let", file: "yes_let.mp3" },
    { text: "yes! nice to meet you! let", file: "yes_nice_to_meet_you_let.mp3" },
    { text: "yes, miss i am sitting down now.", file: "yes_miss_i_am_sitting_down_now.mp3" },
    { text: "yo-yo", file: "yoyo.mp3" },
    { text: "you are a champion", file: "you_are_a_champion.mp3" },
    { text: "you are my friend", file: "you_are_my_friend.mp3" },
    { text: "you look sad. what", file: "you_look_sad_what.mp3" },
    { text: "you look sad", file: "you_look_sad.mp3" },
    { text: "your", file: "your.mp3" },
    { text: "z - zebra", file: "z_zebra.mp3" },
    { text: "zebra", file: "zebra.mp3" },
  ];

  // 精确匹配 - 优先使用童声英式发音
  for (const item of kidsEnglishMap) {
    if (!item) continue;
    if (lower === item.text) {
      return item.file;
    }
  ...
  // 前缀匹配（仅保留3+词的长前缀，避免短前缀截断完整句子）
  // ⚠️ 严禁添加1-2词前缀（如 "i am" → 只播放 i_am.mp3 截断完整句子）
  const prefixMap = [
    // 问候/自我介绍
    ...
    { prefix: "my name is lily", file: "my_name_is_lily_what_about_you.mp3" },
    { prefix: "my name is tom", file: "my_name_is_tom_what_a_great_name.mp3" },
    { prefix: "what is your name", file: "what_is_your_name.mp3" },
    { prefix: "nice to meet you", file: "nice_to_meet_you.mp3" },
    { prefix: "how old are you how", file: "how_old_are_you_how_many_candles.mp3" },
    { prefix: "how old are you", file: "how_old_are_you.mp3" },
    { prefix: "i am from beijing", file: "im_from_beijing.mp3" },
    { prefix: "im from beijing", file: "im_from_beijing.mp3" },
    { prefix: "i m from beijing", file: "im_from_beijing.mp3" },
    { prefix: "i am four years old", file: "i_am_four_years_old_four_candles_on_my_cake.mp3" },
    { prefix: "im four years old", file: "im_five_years_old.mp3" },
    { prefix: "i m five years old", file: "im_five_years_old.mp3" },
    { prefix: "i am five years old", file: "im_five_years_old.mp3" },
    { prefix: "do you want to be my friend", file: "do_you_want_to_be_my_friend.mp3" },
    { prefix: "do you want to be friends", file: "do_you_want_to_be_friends.mp3" },
    { prefix: "yes nice to meet you", file: "yes_let_us_be_friends.mp3" },
    { prefix: "how are you feeling today", file: "how_are_you_feeling_today.mp3" },
    { prefix: "i am feeling happy", file: "im_feeling_happy_today_i_love_school.mp3" },
    { prefix: "im feeling happy", file: "im_feeling_happy_today_i_love_school.mp3" },
    { prefix: "you look sad whats", file: "you_look_sad_whats_wrong.mp3" },
    { prefix: "i lost my toy", file: "i_lost_my_toy_i_feel_very_sad.mp3" },
    { prefix: "why are you so excited", file: "why_are_you_so_excited.mp3" },
    { prefix: "its my birthday today", file: "its_my_birthday_today.mp3" },
    { prefix: "why are you angry", file: "why_are_you_angry.mp3" },
    { prefix: "my sister took my pen", file: "my_sister_took_my_pen_so_i_am_angry.mp3" },
    { prefix: "my sister took my pencil", file: "my_sister_took_my_pencil_im_angry.mp3" },
    // 颜色
    { prefix: "what colour is this", file: "what_colour_is_this_apple.mp3" },
    { prefix: "what is your favourite colour", file: "what_is_your_favourite_colour.mp3" },
    { prefix: "my favourite colour is yellow", file: "my_favourite_colour_is_yellow.mp3" },
    { prefix: "can you see a rainbow", file: "can_you_see_a_rainbow_how_many_colours.mp3" },
    { prefix: "yes a rainbow has", file: "yes_a_rainbow_has_seven_beautiful_colours.mp3" },
    { prefix: "its red red like", file: "its_red_red_like_a_fire_engine.mp3" },
    // 数字
    { prefix: "can you count to ten", file: "can_you_count_to_ten.mp3" },
    { prefix: "how many apples are", file: "how_many_apples_are_on_the_table.mp3" },
    { prefix: "there are five apples", file: "there_are_five_apples_on_the_table.mp3" },
    { prefix: "i am four years old four", file: "i_am_four_years_old_four_candles_on_my_cake.mp3" },
    { prefix: "im four years old four", file: "i_am_four_years_old_four_candles_on_my_cake.mp3" },
    // 动物
    { prefix: "what animal is this", file: "what_animal_is_this_it_says_meow.mp3" },
    { prefix: "its a cat cats", file: "its_a_cat_cats_say_meow.mp3" },
    { prefix: "is the elephant big", file: "is_the_elephant_big_or_small.mp3" },
    { prefix: "the elephant is very big", file: "the_elephant_is_very_big.mp3" },
    { prefix: "what does a lion", file: "what_does_a_lion_do.mp3" },
    { prefix: "a lion roars roar", file: "a_lion_roars.mp3" },
    // 家庭
    { prefix: "who is this in the photo", file: "who_is_this_in_the_photo.mp3" },
    { prefix: "this is my family", file: "this_is_my_family.mp3" },
    { prefix: "is your dad tall", file: "is_your_dad_tall.mp3" },
    { prefix: "yes my dad is", file: "yes_my_dad_is_very_tall_and_strong.mp3" },
    { prefix: "do you love your grandma", file: "do_you_love_your_grandma.mp3" },
    { prefix: "yes i love my grandma", file: "yes_i_love_my_grandma.mp3" },
    // 身体
    { prefix: "where is your nose", file: "where_is_your_nose_can_you_point_to_it.mp3" },
    { prefix: "here is my nose", file: "here_is_my_nose.mp3" },
    { prefix: "how many eyes do", file: "how_many_eyes_do_you_have.mp3" },
    { prefix: "i have two eyes", file: "i_have_two_eyes.mp3" },
    { prefix: "what can you do", file: "what_can_you_do_with_your_hands.mp3" },
    { prefix: "i can clap wave", file: "i_can_clap_wave_draw.mp3" },
    // 食物
    { prefix: "what do you like to eat", file: "what_do_you_like_to_eat.mp3" },
    { prefix: "i like apples and", file: "i_like_apples_and_bananas.mp3" },
    { prefix: "do you like carrots", file: "do_you_like_carrots.mp3" },
    { prefix: "no i dont like carrots", file: "no_i_dont_like_carrots_but_i_like_pizza.mp3" },
    { prefix: "does the cake taste", file: "does_the_cake_taste_good.mp3" },
    { prefix: "yes yummy it is", file: "yes_yummy_it_is_so_delicious.mp3" },
    // 玩具
    { prefix: "what is your favourite toy", file: "what_is_your_favourite_toy.mp3" },
    { prefix: "my favourite toy is", file: "my_favourite_toy_is_my_teddy_bear.mp3" },
    { prefix: "do you want to play ball", file: "do_you_want_to_play_ball_with_me.mp3" },
    { prefix: "yes lets play ball", file: "yes_lets_play_ball_i_love_football.mp3" },
    { prefix: "playing together is", file: "playing_together_is_so_much_fun.mp3" },
    // 课堂指令
    { prefix: "can you sit down", file: "can_you_sit_down_please.mp3" },
    { prefix: "please stand up are", file: "please_stand_up_are_you_ready.mp3" },
    { prefix: "please open your books", file: "please_open_your_books.mp3" },
    { prefix: "who knows the answer", file: "who_knows_the_answer_hands_up.mp3" },
    { prefix: "me me i know", file: "me_me_i_know_the_answer.mp3" },
    { prefix: "yes miss i am", file: "yes_miss_i_am_sitting_down_now.mp3" },
    { prefix: "yes im ready im", file: "yes_im_ready_im_standing_up.mp3" },
    { prefix: "listen carefully and repeat", file: "listen_carefully_and_repeat_after_me.mp3" },
    // 综合复习
    { prefix: "can you sing a song", file: "can_you_sing_a_song_for_us.mp3" },
    { prefix: "yes i can sing", file: "yes_i_can_sing.mp3" },
    { prefix: "what have you learned", file: "what_have_you_learned.mp3" },
    { prefix: "i learned greetings colours", file: "i_learned_greetings_colours_numbers_and_more.mp3" },
    { prefix: "well done congratulations", file: "well_done_congratulations_you_are_amazing.mp3" },
    // 补充扩展句
    { prefix: "four candles on my cake", file: "i_am_four_years_old_four_candles_on_my_cake.mp3" },
    { prefix: "yellow like the sun", file: "my_favourite_colour_is_yellow.mp3" },
    { prefix: "lions are very brave", file: "a_lion_roars.mp3" },
    { prefix: "its the biggest land animal", file: "the_elephant_is_very_big.mp3" },
    { prefix: "she makes yummy food", file: "yes_i_love_my_grandma.mp3" },
    { prefix: "right here in the middle of my face", file: "here_is_my_nose.mp3" },
    { prefix: "two big beautiful eyes", file: "i_have_two_eyes.mp3" },
    { prefix: "and play with my hands", file: "i_can_clap_wave_draw.mp3" },
    { prefix: "they are sweet and yummy", file: "i_like_apples_and_bananas.mp3" },
    { prefix: "can i have more", file: "yes_yummy_it_is_so_delicious.mp3" },
    { prefix: "his name is brown", file: "my_favourite_toy_is_my_teddy_bear.mp3" },
    { prefix: "how many hands do you", file: "how_many_hands_do_you_have.mp3" },
    { prefix: "how many colours", file: "can_you_see_a_rainbow_how_many_colours.mp3" },
    { prefix: "touch your head can", file: "touch_your_head_can_you_do_it.mp3" },
    { prefix: "what is on the farm", file: "what_is_on_the_farm.mp3" },
    { prefix: "what are these are", file: "what_are_these_are_these_eyes.mp3" },
    { prefix: "what sound does", file: "what_sound_does_a_dog_make.mp3" },
    { prefix: "is the sky blue", file: "is_the_sky_blue_or_green.mp3" },
    { prefix: "do you have a brother", file: "do_you_have_a_brother_or_a_sister.mp3" },
    { prefix: "there is a cow", file: "there_is_a_cow_a_pig_a_horse_and_a_chicken.mp3" },
    { prefix: "i have a brother his", file: "i_have_a_brother_his_name_is_tom.mp3" },
    { prefix: "who is he is", file: "who_is_he_is_he_your_dad.mp3" },
    { prefix: "who is she is", file: "who_is_she_is_she_your_mum.mp3" },
    { prefix: "yes he is my dad", file: "yes_he_is_my_dad_i_love_my_dad.mp3" },
    { prefix: "yes she is my mum", file: "yes_she_is_my_mum_my_mum_is_nice.mp3" },
    { prefix: "the sky is blue", file: "the_sky_is_blue_it_is_a_beautiful_blue_sky.mp3" },
    { prefix: "can you draw what", file: "can_you_draw_what_can_you_draw.mp3" },
    { prefix: "can you run fast", file: "can_you_run_fast.mp3" },
    { prefix: "hello hello hello", file: "hello_hello_hello.mp3" },
    { prefix: "head shoulders knees", file: "head_shoulders_knees_and_toes.mp3" },
    { prefix: "sit down sit down", file: "sit_down_sit_down.mp3" },
    { prefix: "stand up stand up", file: "stand_up_stand_up.mp3" },
    { prefix: "listen to me hello", file: "yes_i_can_sing.mp3" },
    { prefix: "so i am angry", file: "so_i_am_angry.mp3" },
  ];
